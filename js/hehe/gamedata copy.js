import games from '../../gamedata/3.json' assert {type: 'json'}
var gameinfo = games;

var gameinfo = games;
var gamename = gameinfo.data.name;
var short_description = gameinfo.data.short_description;
// var genre = gameinfo.data.genres[1].description
...
var gameimg2 = gameinfo.data.screenshots[0].path_thumbnail;
var link = "game1.html";
...
document.getElementById("genre").innerHTML = `<p id="gamenaam" class="informatie">Genre(s): Soundtrack<br> <br></p>`;
